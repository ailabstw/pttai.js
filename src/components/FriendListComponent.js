                ...
                <Link to={friendLink}>
                  <div className={styles['list-item-author']}>
                    ...
                    <div title={constants.STATUS_ARRAY[item.FriendStatus]} className={styles['list-item-author-status']}>
                      <div className={styles['list-item-author-status-circle'] + ' ' + styles[getStatusClass(item.FriendStatus)]}></div>
                    </div>
                  </div>
                  ...
                  <div className={styles['list-item-meta']}>
                    ...
                    <div className={styles['list-item-ellipsis']} onClick={(e) => this.onMenuTrigger(e, item)}></div>
                  </div>
                </Link>
              </div>
            )
